  ...
  >
    ...
    <div class="flex lg:flex-1">
      <div class="flex grow flex-col p-6 lg:pr-28 xl:max-w-[45rem] xl:pr-36">
        <div class="mb-6">
          <v-h>
            <h2 class="text-white">Masaż<br />dla firm</h2>
            <template #under>
        ...
        <div class="flex grow flex-col justify-around gap-4 font-lato">
          ...
          <p>
            ...
            takich firm m.in. jak: STS, KPMG, International Paper, Heineken.
            Niewątpliwym atutem tej formy profilaktyki prozdrowotnej w miejscu
          ...
          <p>
            ...
            20 minut, a więc nie dłużej, niż przerwa na posiłek. Stanowisko
          ...
          <p>
            ...
            biurowego w ramach promocji zdrowia, rozmaitych imprez firmowych,
            dnia kobiet czy innych okazjonalnych wydarzeń, w trakcie których
          ...
          <p>
            ...
            położeniu i pozwoli kompleksowo zająć się przeciążonymi partiami
            ciała. Ta forma masażu może trwać dłużej nawet do 30/40 minut.
          </p>
        </div>
      </div>
    </div>
